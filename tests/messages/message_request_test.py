...
def test_msg_request_creation_success_with_fee_limit():
    msg_request = MsgRequest(
        oracle_script_id=1,
        calldata=bytes.fromhex("000000034254430000000000000001"),
        ask_count=4,
...
def test_msg_request_creation_fee_limit_fail():
    msg_request = MsgRequest(
        oracle_script_id=1,
        calldata=bytes.fromhex("000000034254430000000000000001"),
        ask_count=3,
...
def test_msg_request_creation_prepare_gas_fail():
    msg_request = MsgRequest(
        oracle_script_id=1,
        calldata=bytes.fromhex("000000034254430000000000000001"),
        ask_count=3,
...
def test_msg_request_creation_execute_gas_fail():
    msg_request = MsgRequest(
        oracle_script_id=1,
        calldata=bytes.fromhex("000000034254430000000000000001"),
        ask_count=3,
