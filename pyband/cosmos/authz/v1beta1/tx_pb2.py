...
_MSGEXECRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='cosmos.authz.v1beta1.MsgExecResponse.result', index=0,
...
_MSGEXECRESPONSE.fields_by_name['result'].message_type = cosmos_dot_base_dot_abci_dot_v1beta1_dot_abci__pb2._RESULT
