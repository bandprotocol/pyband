...
class Evidence(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"duplicate_vote_evidence",b"duplicate_vote_evidence",u"light_client_attack_evidence",b"light_client_attack_evidence",u"sum",b"sum"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"duplicate_vote_evidence",b"duplicate_vote_evidence",u"light_client_attack_evidence",b"light_client_attack_evidence",u"sum",b"sum"]) -> None: ...
...
class DuplicateVoteEvidence(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"timestamp",b"timestamp",u"vote_a",b"vote_a",u"vote_b",b"vote_b"]) -> builtins.bool: ...
...
class LightClientAttackEvidence(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"conflicting_block",b"conflicting_block",u"timestamp",b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"byzantine_validators",b"byzantine_validators",u"common_height",b"common_height",u"conflicting_block",b"conflicting_block",u"timestamp",b"timestamp",u"total_voting_power",b"total_voting_power"]) -> None: ...
