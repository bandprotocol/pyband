...
class ValidatorSet(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"proposer",b"proposer"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"proposer",b"proposer",u"total_voting_power",b"total_voting_power",u"validators",b"validators"]) -> None: ...
...
class SimpleValidator(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"pub_key",b"pub_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"pub_key",b"pub_key",u"voting_power",b"voting_power"]) -> None: ...
