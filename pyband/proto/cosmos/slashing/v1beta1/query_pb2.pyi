...
class QuerySigningInfoResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"val_signing_info",b"val_signing_info"]) -> builtins.bool: ...
...
class QuerySigningInfosResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"pagination",b"pagination"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"info",b"info",u"pagination",b"pagination"]) -> None: ...
