...
# sources: cosmos/consensus/v1beta1/query.proto, cosmos/consensus/v1beta1/tx.proto
    ...
    async def update_params(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.consensus.v1beta1.Msg/UpdateParams",
            msg_update_params,
            MsgUpdateParamsResponse,
            timeout=timeout,
            deadline=deadline,
...
class QueryStub(betterproto.ServiceStub):
    async def params(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.consensus.v1beta1.Query/Params",
...
class MsgBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/cosmos.consensus.v1beta1.Msg/UpdateParams": grpclib.const.Handler(
...
class QueryBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/cosmos.consensus.v1beta1.Query/Params": grpclib.const.Handler(
                self.__rpc_params,
                grpclib.const.Cardinality.UNARY_UNARY,
                QueryParamsRequest,
                QueryParamsResponse,
