...
# sources: cosmos/reflection/v1beta1/reflection.proto
    ...
    async def file_descriptors(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.reflection.v1beta1.ReflectionService/FileDescriptors",
...
class ReflectionServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/cosmos.reflection.v1beta1.ReflectionService/FileDescriptors": grpclib.const.Handler(
