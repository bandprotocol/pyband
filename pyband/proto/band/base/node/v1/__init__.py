...
# sources: band/base/node/v1/query.proto
...
class ServiceStub(betterproto.ServiceStub):
    async def chain_id(
        ...
        *,
        ...
        return await self._unary_unary(
            "/band.base.node.v1.Service/ChainID",
            chain_id_request,
            ChainIdResponse,
            timeout=timeout,
            deadline=deadline,
    ...
    async def evm_validators(
        ...
        *,
        ...
        return await self._unary_unary(
            "/band.base.node.v1.Service/EVMValidators",
...
class ServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/band.base.node.v1.Service/ChainID": grpclib.const.Handler(
                self.__rpc_chain_id,
                grpclib.const.Cardinality.UNARY_UNARY,
                ChainIdRequest,
                ChainIdResponse,
            ),
            "/band.base.node.v1.Service/EVMValidators": grpclib.const.Handler(
