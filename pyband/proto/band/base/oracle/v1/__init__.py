...
# sources: band/base/oracle/v1/proof.proto
...
class ServiceStub(betterproto.ServiceStub):
    ...
    async def request_count_proof(
        ...
        *,
        ...
        return await self._unary_unary(
            "/band.base.oracle.v1.Service/RequestCountProof",
...
class ServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/band.base.oracle.v1.Service/Proof": grpclib.const.Handler(
                self.__rpc_proof,
                grpclib.const.Cardinality.UNARY_UNARY,
                ProofRequest,
                ProofResponse,
            ),
            "/band.base.oracle.v1.Service/MultiProof": grpclib.const.Handler(
                self.__rpc_multi_proof,
                grpclib.const.Cardinality.UNARY_UNARY,
                MultiProofRequest,
                MultiProofResponse,
            ),
            "/band.base.oracle.v1.Service/RequestCountProof": grpclib.const.Handler(
